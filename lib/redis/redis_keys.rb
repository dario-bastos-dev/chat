module Redis::RedisKeys
  ...
  WHATSAPP_MESSAGE_MUTEX = 'WHATSAPP_MESSAGE_LOCK::%<inbox_id>s::%<sender_id>s'.freeze

  # Set for 24h after a template edit; its presence is what blocks the next one.
  WHATSAPP_TEMPLATE_EDIT_THROTTLE = 'WHATSAPP_TEMPLATE_EDIT::CHANNEL::%<channel_id>d::TEMPLATE::%<template_id>s'.freeze
