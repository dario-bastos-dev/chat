  ...
  >
    ...
    <template v-for="(tab, index) in tabs" :key="index">
      <button
        ...
        class="relative z-10 px-4 whitespace-nowrap py-1.5 text-sm border-0 outline-1 outline-transparent rounded-lg transition-all duration-200 ease-out hover:text-n-brand active:scale-[1.02]"
        :class="[
          activeTab === index
